/** @filedesc shadcn adapter for NumberInput — numeric input with min/max/step. */
...
function ShadcnNumberInput({ behavior }: { behavior: NumberInputBehavior }) {
...
export const renderNumberInput: AdapterRenderFn<NumberInputBehavior> = createReactAdapter(ShadcnNumberInput);
