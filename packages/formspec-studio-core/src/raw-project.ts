...
export class RawProject {
   ...
   * @returns For a single command: the CommandResult. For an array: an array of CommandResults.
   */
 ...
 * @returns A fully initialized RawProject ready for command dispatch.
 */
