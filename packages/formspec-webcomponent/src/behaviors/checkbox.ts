/** @filedesc Checkbox behavior hook — extracts reactive state for single boolean checkbox fields. */
import { effect } from '@preact/signals-core';
import type { FieldBehavior, FieldRefs, BehaviorContext } from './types';
import { resolveFieldPath, toFieldId, resolveAndStripTokens, bindSharedFieldEffects } from './shared';

export function useCheckbox(ctx: BehaviorContext, comp: any): FieldBehavior {
