...
import type { InquestIssue, InquestSessionV1, RefineSlotProps } from 'formspec-shared';
import { inquestTemplates } from 'formspec-shared';
import { inquestProviderAdapters, createDeterministicAdapter } from '../providers';
import { useSessionLifecycle, summarizeUpload } from '../hooks/useSession';
import { useProviderManager } from '../hooks/useProviderManager';
import { useInquestOps } from '../hooks/useChatOps';
...
interface ChatAppProps {
  refineSlot?: React.ComponentType<RefineSlotProps>;
}

export function ChatApp({ refineSlot: RefineSlot }: ChatAppProps = {}) {
  ...
  return (
    <div data-testid="stack-assistant" className="min-h-screen bg-white text-slate-900 font-ui flex flex-col">
      ...
      {session.phase === 'refine' && draft && RefineSlot && (
        <main className="flex-1 overflow-y-auto p-6">
          {operationError && (
