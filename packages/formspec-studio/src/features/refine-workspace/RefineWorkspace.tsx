            ...
            <div className="space-y-4">
              <section className="rounded-2xl border border-warm-border bg-white/80 p-5 shadow-sm">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    <div className="text-xs font-mono uppercase tracking-[0.24em] text-brass">Refine</div>
                ...
                <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(0,1fr)_320px]">
                  <label className="block">
                    ...
                    <textarea
                      className="min-h-[88px] w-full rounded-md border border-[#dbcdb2] bg-white px-3 py-2 text-sm outline-none focus:border-teal"
              ...
              <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
                <section className="grid min-h-[720px] gap-4 rounded-2xl border border-warm-border bg-white/80 p-4 shadow-sm lg:grid-cols-[minmax(0,1fr)_320px]">
