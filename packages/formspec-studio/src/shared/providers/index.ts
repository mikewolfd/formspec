...
function createDeterministicAdapter(id: string, label: string): InquestProviderAdapter {
  return {
    id,
    label,
    capabilities: {
...
export const inquestProviderAdapters: InquestProviderAdapter[] = [
  createDeterministicAdapter('gemini', 'Gemini'),
  createDeterministicAdapter('openai', 'OpenAI'),
  createDeterministicAdapter('anthropic', 'Anthropic'),
];
