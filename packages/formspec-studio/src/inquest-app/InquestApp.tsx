...
import type { ConnectionResult, InquestIssue, InquestSessionV1, InquestUploadSummary } from '../shared/contracts/inquest';
...
function WelcomeHero({ isAnalyzing, onQuickStart, onToggleGallery }: WelcomeHeroProps) {
  return (
    <div className="mt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
...
function UploadChips({ uploads, onRemove }: UploadChipsProps) {
...
function OperationErrorBanner({ error, onDismiss }: OperationErrorBannerProps) {
  return (
...
function ComposerToolbar({ showFullGallery, onFileUpload, onToggleGallery }: ComposerToolbarProps) {
  return (
              ...
              <InquestThread
                ...
                afterMessages={
                  <InputsAfterMessages
                    ...
                    onQuickStart={(text) => { void handleChatNew(text); }}
