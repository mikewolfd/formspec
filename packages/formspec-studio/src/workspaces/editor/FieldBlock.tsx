...
export function FieldBlock({
  ...
  return (
    <div
      ...
      className={`group relative bg-surface border rounded-[4px] cursor-pointer transition-all flex ${
    ...
    >
      ...
      {/* Drag Handle — full-height left column */}
      <DragHandle className="rounded-l-[3px]" />
