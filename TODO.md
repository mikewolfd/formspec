...
- **Identity attestation bundle shape** `[5 / 3 / 4]` (**20**) — provider-neutral identity-proofing attestation shape shared across WOS and Trellis, lifted from the now-live `SignatureAffirmation.identityBinding` evidence shape so it can travel outside the signature workflow. Tracks [trellis/TODO.md](trellis/TODO.md) "Identity attestation bundle shape" under Blocking / in-flight, and [wos-spec/TODO.md](wos-spec/TODO.md) "Identity attestation shape — generalize beyond signatures". **Gate: signature-workflow evidence shape proven sufficient by the cross-stack WOS-T4 closeout above.**
