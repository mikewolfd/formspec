...
- **ADR 0077 — canonical kernel extension seams** `[6 / 2 / 4]` (**24**) — [`thoughts/archive/adr/0077-canonical-kernel-extension-seams.md`](thoughts/archive/adr/0077-canonical-kernel-extension-seams.md)
...
- **WOS-spec workspace in parent CI** `[5 / 2 / 2]` (**10**)
  ...
  - Add dedicated job (or required check) that runs `cargo nextest run --workspace` inside `wos-spec/`.
