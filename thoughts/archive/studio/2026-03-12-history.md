...
- Fell back to the checked-in Studio screenshots under `thoughts/archive/studio/research-2026-04-14/assets/` (originally `packages/formspec-studio/research/assets/`) and compared those visuals against the current shell/workspace source.
